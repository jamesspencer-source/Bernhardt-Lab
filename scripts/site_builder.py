...
VERIFICATION_LINK_TYPES = {"profile", "directory", "publication", "news", "evidence"}
...
def verification_source_prefix(link_type: str) -> str:
    return {
        "profile": "Profile",
        "directory": "Institutional directory",
        "publication": "Publication evidence",
        "news": "Organization announcement",
        "evidence": "Supporting source",
    }.get(link_type, "Verification source")
...
def render_alumni_cards(people: list[dict[str, Any]], root_prefix: str, flat: bool) -> str:
    ...
    for person in people:
        ...
        cards.append(
            ...
            <div class="alumni-top">{'<span class="alumni-verified">Verified profile</span>' if has_current_profile_link else ''}</div>
...
def render_profile_nav(root_prefix: str, flat: bool, current_section: str) -> str:
    ...
    return f'''          <button class="nav-toggle" type="button" aria-expanded="false" aria-controls="site-nav">Menu</button>
          <nav id="site-nav" class="top-links site-nav" aria-label="Profile navigation">
          ...
          <article class="profile-hero">
            <div class="profile-copy">
              ...
              <div class="actions">
                ...
                {f'<a class="button button-secondary" href="{escape(verified_url)}" target="_blank" rel="noreferrer">Current Institutional Profile</a>' if has_current_profile_link else ''}
              </div>
            </div>
            <figure class="profile-photo-wrap">
